	...
	<div class="dashboard-info">
		<ul class="dashboard-info__list">
			<li class="dashboard-info__item">
				<UITag
					tag-name="All Tasks"
					@tag-click="filterTaskAll()"
					:tag-value="totalTaskList"
				/>
			</li>
			<li class="dashboard-info__item">
				<UITag
					tag-name="Tasks Checked"
					@tag-click="filterTaskIsDone()"
					:tag-value="totalTaskListDone"
				/>
			</li>
			<li class="dashboard-info__item">
				<UITag
					tag-name="Tasks Unchecked"
					@tag-click="filterTaskUnDone()"
					:tag-value="totalTaskListUnDone"
				/>
			</li>
		</ul>
		<ul class="dashboard-info__list">
	...
	export default {
		...
		computed: {
			...mapGetters({
				...
				totalTaskListUnDone: 'getTotalTaskListUnDone'
			})
		},
		methods: {
			...mapActions([
